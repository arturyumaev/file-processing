...
// Package mock_file_info is a generated GoMock package.
package mock_file_info

import (
	context "context"
	reflect "reflect"

	models "github.com/arturyumaev/file-processing/models"
...
func (m *MockService) GetFileInfo(ctx context.Context, name string) (*models.FileInfo, error) {
	m.ctrl.T.Helper()
